...
goog.provide('pwk.dom.PageVisibilityEvent');
goog.provide('pwk.dom.PageVisibilityMonitor');
goog.provide('pwk.dom.PageVisibilityState');
 ...
 * @final
 */
pwk.dom.PageVisibilityMonitor = function(opt_domHelper) {
  pwk.dom.PageVisibilityMonitor.base(this, 'constructor');
...
goog.inherits(pwk.dom.PageVisibilityMonitor, goog.events.EventTarget);
 ...
 * @private
 */
pwk.dom.PageVisibilityMonitor.prototype
    .getBrowserEventType_ = goog.memoize(function() {
  var isSupported =
      /** @type {!pwk.dom.PageVisibilityMonitor} */ (this).isSupported();
  var isPrefixed =
      /** @type {!pwk.dom.PageVisibilityMonitor} */ (this).isPrefixed_();
 ...
 * @private
 */
pwk.dom.PageVisibilityMonitor.prototype.getHiddenPropertyName_ =
    goog.memoize(function() {
      return goog.dom.vendor.getPrefixedPropertyName(
          'hidden',
          /** @type {!pwk.dom.PageVisibilityMonitor} */
 ...
 * @private
 */
pwk.dom.PageVisibilityMonitor.prototype.isPrefixed_ = function() {
 ...
 * @private
 */
pwk.dom.PageVisibilityMonitor.prototype.getVisibilityStatePropertyName_ =
    goog.memoize(function() {
      return goog.dom.vendor.getPrefixedPropertyName(
          'visibilityState',
          /** @type {!pwk.dom.PageVisibilityMonitor} */
 ...
 */
pwk.dom.PageVisibilityMonitor.prototype.isSupported = function() {
 ...
 */
pwk.dom.PageVisibilityMonitor.prototype.isHidden = function() {
  return !!this.domHelper_.getDocument()[this.getHiddenPropertyName_()];
};


/**
 * @return {?pwk.dom.PageVisibilityState} The page visibility state, or
 *     null if not supported.
 */
pwk.dom.PageVisibilityMonitor.prototype.getVisibilityState = function() {
  if (!this.isSupported()) {
    return null;
  }
 ...
 * @private
 */
pwk.dom.PageVisibilityMonitor.prototype.handleChange_ = function(e) {
  var state = this.getVisibilityState();
  var visibilityEvent = new pwk.dom.PageVisibilityEvent(
      this.isHidden(),
      /** @type {pwk.dom.PageVisibilityState} */ (state));
  this.dispatchEvent(visibilityEvent);
};


/** @override */
pwk.dom.PageVisibilityMonitor.prototype.disposeInternal = function() {
  goog.events.unlistenByKey(this.eventKey_);
  pwk.dom.PageVisibilityMonitor.base(this, 'disposeInternal');
};
 ...
 * @param {pwk.dom.PageVisibilityState} visibilityState A more detailed
 *     visibility state.
 * @constructor
 * @extends {goog.events.Event}
 * @final
 */
pwk.dom.PageVisibilityEvent = function(hidden, visibilityState) {
  pwk.dom.PageVisibilityEvent.base(
   ...
   * @type {pwk.dom.PageVisibilityState}
   */
  this.visibilityState = visibilityState;
};
goog.inherits(pwk.dom.PageVisibilityEvent, goog.events.Event);
