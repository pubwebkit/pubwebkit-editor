...
pwk.Page.prototype.createDom = function() {
  ...
  var pageSize = pageSettings.getSize();
...
pwk.Page.prototype.getMaxContentSize = function() {
  ...
  var headerSize = googStyle.getSize(this.header_.getElement());
  // TODO: move to constant
  var footerSize = googStyle.getSize(this.footer_.getElement());
  var pageSize = this.pageSettings_.getSize();
...
pwk.Page.prototype.checkPageOverflow = function() {
  ...
  var contentEl = this.content_.getElement();
  var contentSize = googStyle.getSize(contentEl);
  var maxContentHeight = this.getMaxContentSize();
  ...
  if (contentSize.height > maxContentHeight) {
    ...
    var pageIndex = doc.indexOfPage(this);
    var pageNodes = doc.getPaginationIndex()[pageIndex];
    var pageNodesLength = pageNodes.length;
    var loopNode;
    var newLinkedNode;
