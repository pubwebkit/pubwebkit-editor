...
goog.provide('pwk.dom.PageVisibilityMonitorTest');
goog.setTestOnly('pwk.dom.PageVisibilityMonitorTest');

goog.require('goog.events');
goog.require('goog.functions');
goog.require('pwk.dom.PageVisibilityMonitor');
...
function testConstructor() {
  vh = new pwk.dom.PageVisibilityMonitor();
}

function testNoVisibilitySupport() {
  stubs.set(
      pwk.dom.PageVisibilityMonitor.prototype, 'getBrowserEventType_',
      goog.functions.NULL);
